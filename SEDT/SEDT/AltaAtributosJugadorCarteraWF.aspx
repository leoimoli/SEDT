<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="AltaAtributosJugadorCarteraWF.aspx.cs" Inherits="SEDT.AltaAtributosJugadorCarteraWF" %>
    ...
    <div class="right_col" role="main">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="form-horizontal form-label-left">
                <div class="x_panel">
                    <div class="x_title">
                        <h2><i class="fa fa-users"></i>Atributos <small>Complete los campos para agregar los atributos del jugador seleccionado.</small></h2>
                    ...
                    <div class="x_content">
                        ...
                        <div class="form-group">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <button id="btn_AltaFichaJugador_Guardar" class="btn btn-primary" style="display: inline-block;" onclick="AltaFichaTecnicaCartera_Guardar()" type="button">Guardar</button>
                                <button id="btn_AltaFichaJugador_Limpiar" class="btn btn-primary" style="display: inline-block;" onclick="AltaFichaTecnicaCartera_Limpiar()" type="button">Limpiar</button>
